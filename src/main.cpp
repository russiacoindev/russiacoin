...
int64 nChainStartTime = 1402185790;
...
const string strMessageMagic = "RussiaCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in RussiaCoin
    bool fStrictPayToScriptHash = true; // Always active in RussiaCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RussiaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "russiacoin bliat!";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1402185790; //
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3068063;
        ...
        assert(block.hashMerkleRoot == uint256("009c94dc96090fc3d4944f50073e6b0da23f30e6c34bbd9291553c072915f1e9"));//merkel
